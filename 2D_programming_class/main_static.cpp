...
int main(int argc, char **argv)
{
	...
	unsigned char *my_own_buffer = (unsigned char*)malloc(sizeof(unsigned char)*screen_height*screen_width * 3);
	...
	for(;;)
	{
		...
		/*for (int i = 0; i < screen_height*screen_width; i++)
		{
			...
			my_own_buffer[i * 3 + 1] = rand() % 256;
			my_own_buffer[i * 3 + 2] = rand() % 256;
		}*/
		
		memcpy(your_draw_buffer->pixels, my_own_buffer, screen_height * screen_width * 3);
