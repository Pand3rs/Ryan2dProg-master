...
int main(int argc, char **argv)
{
	...
	drawLine(my_own_buffer, 10, 10, 10, 500, 255, 255, 255, 255);
	drawLine(my_own_buffer, 10, 500, 500, 500, 255, 255, 255, 255);
	drawLine(my_own_buffer, 500, 500, 500, 10, 255, 255, 255, 255);
	drawLine(my_own_buffer, 500, 10, 10, 10, 255, 255, 255, 255);
	drawLine(my_own_buffer, 10, 10, 500, 500, 255, 255, 255, 255);
	drawLine(my_own_buffer, 500, 10, 10, 500, 255, 255, 255, 255);
